...
def generate_alert_message(alert_data: Dict[str, Any], alert_type: str = "general") -> str:
    """Generate a formatted alert message from alert data with complete match information.
    
    Args:
        alert_data: Dictionary with alert information
        alert_type: Type of alert (odds, score, environment)
...
def should_deduplicate_alert(match_id: str, alert_type: str, previous_alerts: Dict[str, List[str]], 
    ...
    Args:
        ...
        threshold_seconds: Time threshold for deduplication (default: 900 seconds / 15 minutes)
