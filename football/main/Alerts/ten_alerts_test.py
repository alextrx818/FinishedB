...
Generate 10 consecutive alerts with 10-second spacing between each.
"""
...
def main():
    ...
    # Generate and log 10 alerts with 10 second spacing
    num_alerts = 10
    ...
    print(f"Generated {num_alerts} alerts with 10-second spacing between each.")
